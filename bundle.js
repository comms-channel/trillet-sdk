        ...
        try {
          ...
          if (done) {
            ...
            return {
              ...
              value: decoder2.decode(value.content)
            };
          }
        } catch (error) {
          return {
...
var isSecureContext = isBrowser && window.isSecureContext;
var TrilletAgent = class extends import_index.default {
  constructor(config) {
    super();
    this.sdkToken = null;
    this.transcripts = [];
  ...
  setupEventForwarding() {
    ...
    (_a = this.sdk.getRoom()) === null || _a === void 0 ? void 0 : _a.on(RoomEvent.TranscriptionReceived, (segments, participant) => {
      ...
      const isAgent = participantId.startsWith("agent-") || participantId.startsWith("web-agent");
      segments.forEach((segment) => {
        ...
        if (segment.final) {
          ...
          if (lastMessage && lastMessage.text === text && lastMessage.participantId === participantId && Date.now() - lastMessage.timestamp.getTime() < 1e3) {
            return;
          }
          this.transcripts.push({
            ...
            toolUsed: text.includes("Using tool:") ? {
              ...
              args: (_a2 = text.split("Arguments:")[1]) === null || _a2 === void 0 ? void 0 : _a2.trim(),
              status: "pending"
            } : void 0
          });
        } else {
...
var TrilletWebSDK = class extends import_index.default {
  constructor() {
    super();
